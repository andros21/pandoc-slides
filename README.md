<h1> pandoc-slides <a href="https://github.com/andros21/pandoc-slides/blob/master/.github/workflows/build.yml">
...
> **Warning:** `pandoc-slides` image is (at the moment) available only for `x86_64` architecture
